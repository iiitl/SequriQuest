...
const initialChallenges: Challenge[] = [
  { id: 1, title: "Challenge 1", description: "Pointy pointers.", points: 50, hint: "Is the source code in C?" },
  { id: 2, title: "Challenge 2", description: "Disk Diving.", points: 100, hint: "Dive deep to find the best gems." },
  { id: 3, title: "Challenge 3", description: "Easy search.", points: 150, hint: "Its not that easy. LOL." },
  { id: 4, title: "Challenge 4", description: "Secret hunting.", points: 50, hint: "The file is not as innocent as it looks." },
  { id: 5, title: "Challenge 5", description: "Reverse Engineering 101.", points: 100, hint: "Don't overthink it." },
  { id: 6, title: "Challenge 6", description: "Eye catcher.", points: 100, hint: "Don't believe your eyes." },
  { id: 7, title: "Challenge 7", description: "Julius encrypted his password using a simple encryption algorithm. Can you decode it?", points: 50, hint: "USA!!USA!!USA!!" },
  { id: 8, title: "Challenge 8", description: "A mysterious post was found on reddit. Can you uncover its truth?", points: 50, hint: "ETUTITSBUS" },
  { id: 9, title: "Challenge 9", description: "Numbers and Deception: Sometimes, the greatest value isn’t what it seems.", points: 100, hint: "Read the code." },
  { id: 10, title: "Challenge 10", description: "Rainb0lt who?", points: 100, hint: "Try searching on planet Earth." },
  { id: 11, title: "Challenge 11", description: "Find the photographer's home location.", points: 100, hint: "Sometimes, we share more online than we realize." },
  { id: 12, title: "Challenge 12", description: "Just Copy n Paste", points: 100, hint: "tired of using chatgpt" },
  { id: 13, title: "Challenge 13", description: "Just look inside", points: 50, hint: "do you really need it?" },
  { id: 14, title: "Challenge 14", description: "I love Marie", points: 100, hint: "Is Marie really a person or a thing :> ?" },
  { id: 15, title: "Challenge 15", description: "Authentication Unlock", points: 100, hint: " " },
  { id: 16, title: "Challenge 16", description: "Terah", points: 50, hint: "flag format iiitl{flag}" }
];
